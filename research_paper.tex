...
The proposed method achieves a substantially lower BRISQUE score ($-$23.07 vs.\ 66.40), indicating significantly reduced perceptual distortion in the SR output. The NIQE score of the proposed method (11.92) is higher than that of bicubic interpolation (9.24). This behaviour is consistent with findings reported in the super-resolution literature: NIQE is calibrated on natural photographic images and penalises the enhanced high-frequency structures produced by SR networks as deviations from its natural-image prior, even when those structures correspond to genuine scene detail~\cite{mittal2013niqe}. The BRISQUE metric, which assesses image quality through locally normalised luminance coefficients without relying on a fixed natural-image corpus, more reliably reflects the reduction in blur and blocking artefacts achieved by the proposed method on satellite imagery.
...
The experimental results demonstrate that the proposed dual-image super-resolution framework consistently improves reconstruction quality over single-image baselines under both supervised and reference-free settings. The proposed method achieves a PSNR gain of $+1.32$~dB and a SSIM gain of $+0.049$ over the single-image baseline on NWPU-RESISC45, demonstrating that fusing complementary bicubic-centric observations enhances reconstruction fidelity. Furthermore, the blind evaluation on Sentinel-2 imagery yields a BRISQUE score of $-$23.07 for the proposed method compared to 66.40 for bicubic interpolation, indicating substantially reduced perceptual distortion under real satellite imaging conditions. The higher NIQE score of the SR output reflects a known sensitivity of NIQE to enhanced high-frequency content rather than a degradation in image quality.
